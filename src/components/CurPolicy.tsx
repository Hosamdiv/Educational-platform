...
const CurPolicy = () => {
    return (
        ...
        justify-around gap-12 sm:gap-2
        text-center py-20 text-xs sm:text-sm md:text-base
      text-gray-700">
            ...
            <div>
                ...
                <p className="font-semibold">7 Days Return Plicy</p>
